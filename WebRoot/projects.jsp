...
<html>
  ...
  <body>
  	...
  	<div id="container">
  		...
  		<div id="position">位置：<a href="home.action">首页</a>》${menu.firstlist.name}》${menu.name}
  		...
  		<div id="projects">	
  			<div id="projects_top">
  					<table>
  						<tr>
  						<td width="186"><span class="title">项目标题</span></td>
  			...
  			<div id="content_bottom">
  				...
  				<a href="showprojects.action?secondlist=<s:property value="#secondlist"/>&&currentPage=1">首页</a>

  					<s:if test="#page.hasprevious">
  						<a href="showprojects.action?secondlist=<s:property value="#secondlist"/>&&currentPage=<s:property value="#page.currentpage-1"/>">上一页</a>
  					</s:if>
  					<s:else>
						<a href="showprojects.action?secondlist=<s:property value="#secondlist"/>&&currentPage=<s:property value="#page.currentpage"/>">上一页</a>
  					</s:else>

  					<s:if test="#page.hasnext">
  						<a href="showprojects.action?secondlist=<s:property value="#secondlist"/>&&currentPage=<s:property value="#page.currentpage+1"/>">下一页</a>
  					</s:if>
  					<s:else>
  						 <a href="showprojects.action?secondlist=<s:property value="#secondlist"/>&&currentPage=<s:property value="#page.currentpage"/>">下一页</a>
  					</s:else>
  					
					<a href="showprojects.action?secondlist=<s:property value="#secondlist"/>&&currentPage=<s:property value="#page.totalpage"/>">尾页</a>
